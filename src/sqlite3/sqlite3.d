...
int sqlite3_memory_alarm(
  void function(void* pArg, sqlite3_int64 used, int N) xCallback,
  void* pArg,
...
int sqlite3_set_authorizer(
  sqlite3*,
  int function(void*,int,char*,char*,char*,char*) xAuth,
  void* pUserData
);
...
const SQLITE_TRANSACTION =         22;   /* NULL            NULL            */
...
const SQLITE_FUNCTION =            31;   /* Function Name   NULL            */
...
int sqlite3_open16(
  void* filename,         /* Database filename (UTF-16) */
  sqlite3** ppDb          /* OUT: SQLite db handle */
);
int sqlite3_open_v2(
  char* filename,         /* Database filename (UTF-8) */
...
int sqlite3_prepare16(
  sqlite3* db,            /* Database handle */
  void* zSql,             /* SQL statement, UTF-16 encoded */
  int nByte,              /* Maximum length of zSql in bytes. */
  sqlite3_stmt** ppStmt,  /* OUT: Statement handle */
...
*/
struct sqlite3_value; // struct Mem
...
int sqlite3_create_collation(
  ...
  int eTextRep,
  void*,
  int function(void*,int,void*,int,void*) xCompare
);
...
int sqlite3_collation_needed(
  sqlite3*,
  void*,
  void function(void*,sqlite3*,int eTextRep,char*)
);
int sqlite3_collation_needed16(
  sqlite3*,
  void*,
  void function(void*,sqlite3*,int eTextRep,void*)
);
...
int sqlite3_rekey(
  sqlite3 *db,                   /* Database to be rekeyed */
  void* pKey, int nKey           /* The new key */
);
...
int sqlite3_table_column_metadata(
  ...
  char* zDbName,              /* Database name or NULL */
  char* zTableName,           /* Table name */
  char* zColumnName,          /* Column name */
...
int sqlite3_load_extension(
  ...
  char* zProc,          /* Entry point.  Derived from zFile if 0 */
...
struct sqlite3_module {
  ...
  int function(sqlite3_vtab_cursor*, int idxNum, char* idxStr,
  ...
  int function(sqlite3_vtab* pVtab, int nArg, char* zName,
...
int sqlite3_create_module(
  ...
  sqlite3_module*,           /* Methods for the module */
...
const SQLITE_MUTEX_STATIC_MEM2 =     4;  /* sqlite3_release_memory() */
