...
public:
    this(string data){
        this.value = data;
        this._scalar_style = ScalarStyle.plain; //???
    ...
    this(yaml_node_t* node, yaml_document_t document){
        ...
        void rec(
            ...
            if(st == tp){
                ...
                if(node !is null){
                    this.node_sequence.push_back(create_yaml_node(node, document));
                }else{
