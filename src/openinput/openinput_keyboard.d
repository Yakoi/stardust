/* Converted to D from openinput_keyboard.h by htod */
module openinput.openinput_keyboard;
/*
...
//C     #ifndef _OPENINPUT_KEYS_H_
//C     #define _OPENINPUT_KEYS_H_
...
// Miscellaneous function keys
    ...
    } /**< Definition of keyboard button names */
enum
{
    OIK_UNKNOWN,
    OIK_FIRST = 0,
 ...
 * @{
 */
//C     #define OIM_NONE         0x0000 /**< Nothing */
//C     #define OIM_LSHIFT       0x0001 /**< Left shift */
const OIM_NONE = 0x0000;
//C     #define OIM_RSHIFT       0x0002 /**< Right shift */
const OIM_LSHIFT = 0x0001;
//C     #define OIM_LCTRL        0x0040 /**< Left control */
const OIM_RSHIFT = 0x0002;
//C     #define OIM_RCTRL        0x0080 /**< Right control */
const OIM_LCTRL = 0x0040;
//C     #define OIM_LALT         0x0100 /**< Left alt */
const OIM_RCTRL = 0x0080;
//C     #define OIM_RALT         0x0200 /**< Right alt */
const OIM_LALT = 0x0100;
//C     #define OIM_LMETA        0x0400 /**< Left meta */
const OIM_RALT = 0x0200;
//C     #define OIM_RMETA        0x0800 /**< Right meta */
const OIM_LMETA = 0x0400;
//C     #define OIM_NUMLOCK      0x1000 /**< NumLock */
const OIM_RMETA = 0x0800;
//C     #define OIM_CAPSLOCK     0x2000 /**< CapsLock */
const OIM_NUMLOCK = 0x1000;
//C     #define OIM_ALTGR        0x4000 /**< Alt graphics */
const OIM_CAPSLOCK = 0x2000;
//C     #define OIM_SCROLLOCK    0x8000 /**< ScrollLock */
const OIM_ALTGR = 0x4000;
/** @} */
const OIM_SCROLLOCK = 0x8000;
 ...
 */
//C     typedef struct {
//C         unsigned char scancode;       /**< Hardware scancode */
//C         oi_key sym;                   /**< Key symbol */
//C         unsigned int mod;             /**< Modifier symbol */
//C     } oi_keysym;
struct oi_keysym
{
    ubyte scancode;
